...
---
[[Home MOC|Home]] / [[Education & Learning MOC|Education & Learning]] / [[5 - Unit Tests]]
...
You can learn more in Python’s documentation of [`assert`](https://docs.python.org/3/reference/simple_stmts.html#the-assert-statement).
...
You can learn more in Pytest’s documentation of [`pytest`](https://docs.pytest.org/).
...
You can learn more in Pytest’s documentation of [import mechanisms](https://docs.pytest.org/en/stable/pythonpath.html).
